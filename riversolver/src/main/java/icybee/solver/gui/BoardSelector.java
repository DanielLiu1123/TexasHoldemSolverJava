...
public class BoardSelector {
    ...
    public BoardSelector(
            BoardSelectorCallback callback, String init_board_str, RangeSelector.RangeType type, Frame frame) {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < columnName.length; j++) {
                ...
                String one_color_str = String.valueOf(colors.charAt(i))
        ...
        board_table.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                if (v.height > p.height) {
                    int available = v.height - board_table.getRowCount() * board_table.getRowMargin();
