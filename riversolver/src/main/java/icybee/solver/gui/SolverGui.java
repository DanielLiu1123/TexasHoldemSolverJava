...
public class SolverGui {
    ...
    private @Nullable Compairer compairer_holdem = null;
    private @Nullable Compairer compairer_shortdeck = null;
    private @Nullable Deck holdem_deck = null;
    private @Nullable Deck shortdeck_deck = null;
    ...
    GameTreeBuildingSettings parseSettings() {
        ...
        GameTreeBuildingSettings gameTreeBuildingSettings =
                new GameTreeBuildingSettings(flop_ip, turn_ip, river_ip, flop_oop, turn_oop, river_oop);
    ...
    private void solve() throws Exception {
        ...
        Compairer compairer = java.util.Objects.requireNonNull(
                mode.getSelectedIndex() == 0 ? this.compairer_holdem : this.compairer_shortdeck,
                "compairer not loaded");
