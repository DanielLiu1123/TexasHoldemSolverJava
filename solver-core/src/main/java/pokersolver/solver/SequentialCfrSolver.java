 ...
 * this class contributes only the scheduling discipline, and the CFR variant is chosen by {@link
 * Algorithm}.
 */
public final class SequentialCfrSolver extends AbstractCfrSolver {

    public SequentialCfrSolver(SolverConfig config) {
        super(config);
    }
