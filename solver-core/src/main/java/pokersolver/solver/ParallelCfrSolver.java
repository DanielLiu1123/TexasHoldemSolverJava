...
/**
 * Parallel CFR solver: children are evaluated as forked ForkJoin tasks rather than in-line recursion.
 * Everything else — the traversal, the training loop — is shared with {@link SequentialCfrSolver} via
 * {@link AbstractCfrSolver}.
 *
 ...
 */
public final class ParallelCfrSolver extends AbstractCfrSolver {

    private static final Logger log = LoggerFactory.getLogger(ParallelCfrSolver.class);
